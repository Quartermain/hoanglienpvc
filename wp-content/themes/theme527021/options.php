...
// ---------------------------------------------------------
			...
			$background_defaults = array(
				'color' => '#333f3f',
				'image' => CHILD_URL . '/images/bg_body.png',
				'repeat' => 'repeat',
				'position' => 'top center',
				'attachment'=>'scroll'
			);
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '12px', 'lineheight' => '18px', 'face' => 'Ubuntu', 'style' => 'normal', 'character'  => 'latin', 'color' => '#909090'));

			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '48px', 'lineheight' => '48px', 'face' => '"Trebuchet MS", Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#414141'));

			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '40px', 'lineheight' => '58px', 'face' => '"Trebuchet MS", Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#414141'));
			...
			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '16px', 'lineheight' => '18px', 'face' => '"Trebuchet MS", Arial, Helvetica, sans-serif', 'style' => 'bold', 'character'  => 'latin', 'color' => '#414141'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '36px', 'lineheight' => '48px', 'face' => '"Trebuchet MS", Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#414141'));

			$options['h6_heading'] = array(
								'id' => 'h6_heading',
								'std' => array( 'size' => '18px', 'lineheight' => '24px', 'face' => '"Trebuchet MS", Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#64a0bc'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '48px', 'lineheight' => '30px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '14px', 'lineheight' => '30px', 'face' => '"Trebuchet MS", Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '12px', 'lineheight' => '30px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#80878e'));
// ---------------------------------------------------------
// Parallax Slider
// ---------------------------------------------------------
